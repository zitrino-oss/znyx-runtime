...
from app.shared.policy.bundle import (
    PolicyBundle, load_bundle_from_file, save_bundle_to_file,
    validate_bundle, BUNDLE_FORMAT_VERSION,
)
from app.shared.policy.loader import PolicyLoader
from app.shared.policy.resolver import PolicyResolver
...
class BundleManager:
    ...
    from app.config.tunables import BUNDLE_BOOT_RETRY_DELAYS_SECONDS as _BOOT_RETRY_DELAYS
