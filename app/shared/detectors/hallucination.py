...
class HallucinationDetector:
    ...
    def detect(self, text: str) -> DetectorResult:
        ...
        # Pre-compute source embeddings if using embedding method
        ...
        return DetectorResult(
            ...
            developer_message=(
                f"hallucination: {len(ungrounded_claims)} ungrounded, "
